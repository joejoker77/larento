...
class Category extends Model
{
    ...
    const TEMPLATE_DEFAULT   = 'blog';
    const TEMPLATE_PROMOTION = 'promotion';
    ...
    protected $fillable = [
        'name', 'slug', 'title', 'parent_id', 'description', 'status', 'meta', 'photo', 'template_name'
    ];
...
//        });
    ...
    {
        return [
            self::TEMPLATE_DEFAULT   => 'Шаблон по умолчанию',
            self::TEMPLATE_PORTFOLIO => 'Шаблон для портфолио',
            self::TEMPLATE_PROMOTION => 'Шаблон для акции'
        ];
    }
    ...
    {
        return $this->hasMany(Post::class)->with(['photos', 'category']);
    }
