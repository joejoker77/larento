            ...
            <div class="p-3 mb-3 bg-light border">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="template_name" class="js-choices" data-placeholder="-=Выбрать шаблон=-">
                            <option></option>
                            @foreach($category::getTemplates() as $template => $templateName)
                                <option value="{{ $template }}" @selected($category->template_name == $template)>{{ $templateName }}</option>
                            @endforeach
                        </select>
