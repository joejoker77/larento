            ...
            <div class=@if($filter)"col-md-6"@else"col-md-12"@endif>
                <div class="p-3 mb-3 bg-light border ''">
                    ...
                    <div class="form-floating">
                        ...
                        <select name="categories[]" class="js-choices" multiple data-placeholder="-=Выбрать категорию=-">
                            <option></option>
                ...
                <div class="p-3 mb-3 bg-light border ''">
                    <h4>Позиция</h4>
                    <div class="form-floating mb-3">
                        <select name="position" class="js-choices" data-placeholder="-=Выбрать Позицию=-">
                            <option></option>
