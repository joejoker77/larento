    ...
    <div class="my-4">
        ...
        <form method="POST" action="{{ route('admin.shop.attributes.update', $attribute) }}">
            ...
            <div class="p-3 mb-3 bg-light border ''">
                ...
                <div class="mb-3">
                    <select id="type" class="form-select js-choices @error('type') is-invalid @enderror" name="type" required data-placeholder="-=Выбрать тип значения=-">
                        <option></option>
                ...
                <div class="mb-0">
                    <select id="mode" class="js-choices @error('mode') is-invalid @enderror" name="mode" required data-placeholder="-=Выбрать режим атрибута=-">
                        <option></option>
            ...
            <div class="p-3 mb-3 bg-light border ''">
                ...
                <div class="row">
                    ...
                    <select name="categories[]" class="js-choices" multiple data-placeholder="-=Выбрать категории=-">
                        <option></option>
