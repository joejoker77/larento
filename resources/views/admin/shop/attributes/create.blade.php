    ...
    <div class="my-4">
        ...
        <form method="POST" action="{{ route('admin.shop.attributes.store') }}">
            ...
            <div class="p-3 mb-3 bg-light border ''">
                ...
                <div class="mb-3">
                    <select id="type" class="js-choices @error('type') is-invalid @enderror" name="type" required data-placeholder="-=Выбрать тип значения=-">
                        <option></option>
                ...
                <div class="mb-0">
                    <select id="mode" class="js-choices @error('mode') is-invalid @enderror" name="mode" required data-placeholder="-=Выбрать тип атрибута=-">
                        <option></option>
