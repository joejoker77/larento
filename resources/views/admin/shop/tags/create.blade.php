...
@section('content')
    <form method="POST" action="{{ route('admin.shop.tags.store') }}">
        @csrf
        <div class="row mt-4">
            <h3 class="mb-4 pb-4 border-bottom">Создание нового тега</h3>
            <div class="col-md-6">
                <div class="p-3 mb-3 bg-light border ''">
                    <h4>Основные</h4>
                    <div class="form-floating">
                        <input id="name" class="form-control @error('name') is-invalid @enderror"
                               name="name" value="{{ old('name') }}" type="text" placeholder="Наименование тега" required>
            ...
            <div class="col-md-6">
                <div class="p-3 mb-3 bg-light border ''">
                    <h4>Сео текст</h4>
                    <div class="form-text">
                        <textarea id="short_description" name="seo_text" aria-label="Сео текст для тега"
