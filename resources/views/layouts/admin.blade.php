...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="{{ route('home') }}" target="_blank">Larento Сайт</a>
                ...
                <ul class="nav flex-column" id="nav_accordion">
                    ...
                    <li class="nav-item has-submenu">
                        ...
                        <ul class="submenu collapse @if(request()->is('admin/shop*')) show @endif">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(request()->is('admin/shop/promotion*')) active @endif" href="{{ route('admin.shop.promotion.index') }}">
                                    <span data-feather="gift" class="align-text-bottom"></span>
                                    Баннер/Акции
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.shop.commentaries.index') }}" class="nav-link @if(request()->is('admin/shop/commentaries*')) active @endif">
                                    <span class="align-text-bottom" data-feather="clipboard"></span>
                                    Комментарии
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.shop.orders.index') }}" class="nav-link @if(request()->is('admin/shop/orders*')) active @endif">
